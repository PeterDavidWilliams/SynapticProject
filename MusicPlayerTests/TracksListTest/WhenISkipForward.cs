...
namespace MusicPlayerTests.TracksListTest
{
    ...
    public class WhenISkipForward
    {
        ...
        public void ThenTheCurrentlyPlayingSongWillBeUpdated()
        {
            ...
            //Assert
            Assert.AreEqual(1, tracksList.CurrentlyPlayingIndex);
        }

        [TestMethod]
        public void AndTheLastSongIsCurrentlyPlayingThenTheFirstTrackWillBePlayed()
        {
            //Arrange
            Setup();
            tracksList.CurrentlyPlayingIndex = tracksList.CurrentlyPlaying.Count - 1;
            //Act
            tracksList.SkipForward();
            //Assert
